...
export default function CreateSubscriptionPage() {
  ...
  const handleSave = async () => {
    ...
    if (selectedTools.length === 0) {
      toast({
        title: "Error",
        description: "Please select at least one tool for this subscription plan.",
        variant: "destructive",
      })
      return
    }
          ...
          <div className="lg:col-span-1">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Configure the subscription plan</CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <div className="lg:col-span-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Configure which tools are included in this subscription plan</CardDescription>
              </CardHeader>
              <CardContent>
