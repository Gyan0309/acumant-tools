          ...
          <TabsContent value="appearance">
            <Card className="card-hover shadow-soft">
              <CardHeader>
                ...
                <CardDescription>Customize your organization's branding within the platform</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                ...
                <Alert className="bg-blue-50 dark:bg-blue-950/30 border-blue-200 dark:border-blue-900/50 text-blue-800 dark:text-blue-300">
                  ...
                  <AlertDescription>
                    The platform name, description, and support email are managed by Acumant and cannot be modified. You
                    can customize your organization's logo and appearance settings.
                  </AlertDescription>
                </Alert>
                ...
                <div className="space-y-4 mt-4">
                  <div className="space-y-2">
                    ...
                    <Input id="platform-name" value="Acumant Tools" disabled className="bg-muted/50" />
                    <p className="text-xs text-muted-foreground">Managed by Acumant</p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="support-email" value="support@acumant.com" disabled className="bg-muted/50" />
                    <p className="text-xs text-muted-foreground">Managed by Acumant</p>
                  </div>
                </div>
          ...
          <TabsContent value="models">
            <Card className="card-hover shadow-soft">
              <CardHeader>
                ...
                <CardDescription>Configure AI models for different tools</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  <div className="space-y-2">
                    <Label>Chat Tool Model</Label>
                    <ModelSelector toolId="chat" currentModel={settings.models?.chat || "gpt-4o"} />
                  </div>
                  <div className="space-y-2">
                    <Label>Deep Research Tool Model</Label>
                    <ModelSelector toolId="deep-research" currentModel={settings.models?.deepResearch || "gpt-4o"} />
                  </div>
                </div>
            ...
            <Card className="card-hover shadow-soft">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="pinecone-key" type="password" defaultValue={settings.apiKeys?.pinecone || ""} />
                </div>
