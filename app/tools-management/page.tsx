...
export default function ToolsManagementPage() {
      ...
      try {
        ...
        const extendedTools = [
          ...toolsData,
          {
            ...
            description:
              "Create high-quality blog posts, articles, and marketing copy with advanced AI technology",
          ...
          },
          {
            ...
            description:
              "Extract meaningful insights from complex datasets with AI-powered analysis",
          ...
          },
          {
            ...
            description:
              "Accelerate development with AI-powered code suggestions, debugging, and optimization",
  ...
  const handleToolToggle = (toolId: string) => {
    ...
    toast({
      ...
      description: `Tool has been ${
        tools.find((t) => t.id === toolId)?.isActive ? "disabled" : "enabled"
      }.`,
    });
  };
  ...
  const filteredTools =
    activeTab === "all"
      ...
      : tools.filter((tool) => {
          if (
            activeTab === "content" &&
            ["ai-content-generator"].includes(tool.slug)
          )
            return true;
          if (
            activeTab === "data" &&
            ["data-formulator", "data-insights-engine"].includes(tool.slug)
          )
            return true;
          if (
            activeTab === "development" &&
            ["ai-code-assistant"].includes(tool.slug)
          )
            return true;
          if (
            activeTab === "business" &&
            ["chat", "deep-research"].includes(tool.slug)
          )
            return true;
          return false;
        });
      ...
      <main className="flex-1 container py-10">
        <div className="mb-6">
          ...
          <p className="text-muted-foreground mt-1">
            Enable or disable tools across the platform
          </p>
        </div>
